...
if game.Players.LocalPlayer.Character then
   ...
   if Remote ~= nil then
      ...
      if game.Players.LocalPlayer.PlayerGui:FindFirstChild("LoadingScreen1") then
         game.Players.LocalPlayer.PlayerGui:FindFirstChild("LoadingScreen1").Enabled = false
      end
      if game.Players.LocalPlayer.PlayerGui:FindFirstChild("LoadingScreen") then
         game.Players.LocalPlayer.PlayerGui:FindFirstChild("LoadingScreen").Enabled = false
      end
